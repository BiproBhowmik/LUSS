...
public class NoticeAdd extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //back button
        getSupportActionBar().setTitle("Add a Notice");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        title = findViewById(R.id.noticeTitleID);
        discription = findViewById(R.id.noticeDecID);
        submitButton = findViewById(R.id.noticeSend);
        pictureUpload = findViewById(R.id.noticePictureUpload);
    ...
    public void onClick(final View v) {
        if (v.getId() == R.id.noticeSend) {
            ...
            if (!title_val.isEmpty() && !dicription_val.isEmpty() /*&& netConnection*/) {
                ...
                mProgress = ProgressDialog.show(this, "LU Bus Helper", "Adding a Notice ... ");

                if (imageUri != null) {
                    StorageReference filePath = mStorage.child("NoticePictures").child(imageUri.getLastPathSegment()/*return image name*/);
...
//                                    startActivity(new Intent(Post_Activity.this, Main2Activity.class));
                    ...
                    Snackbar.make(v, "A Notice added successfully", Snackbar.LENGTH_LONG).show();
        ...
        } else if (v.getId() == R.id.noticePictureUpload) {
