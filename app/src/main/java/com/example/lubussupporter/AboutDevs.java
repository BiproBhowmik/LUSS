...
public class AboutDevs extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //back button
        getSupportActionBar().setTitle("The Developers");
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.facebookProfile) {
            goToUrl("https://www.facebook.com/biprojoy");
