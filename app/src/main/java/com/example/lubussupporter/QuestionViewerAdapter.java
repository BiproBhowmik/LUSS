...
public class QuestionViewerAdapter extends RecyclerView.Adapter<QuestionViewerViewHolder> {
    ...
    public QuestionViewerAdapter(Context context, List<Question_StoreToDB> databaseList) {
