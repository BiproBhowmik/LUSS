...
public class BusScheduleExamAdd extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bus_schedule_exam_add);

        mDatabase = FirebaseDatabase.getInstance().getReference().child("Bus Schedule Exam");
        mStorage = FirebaseStorage.getInstance().getReference();

        //back button
        getSupportActionBar().setTitle("Add a Exam Bus Schedule");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        title = findViewById(R.id.examTitleID);
        submitButton = findViewById(R.id.examSend);
        pictureUpload = findViewById(R.id.examPictureUpload);
    ...
    public void onClick(final View v) {
        if (v.getId() == R.id.examSend) {
            ...
            if (!title_val.isEmpty() && imageUri != null) {
                ...
                mProgress = ProgressDialog.show(this, "LU Student Suporter", "Adding Exam Bus Schedule ... ");

                StorageReference filePath = mStorage.child("ExamBusSchedulePictures").child("ExamBusSchedulePictures");//.child(imageUri.getLastPathSegment()/*return image name*/);
...
//                                    mProgress.dismiss();
                                ...
                                final String key = "exambusschedule";
        ...
        } else if (v.getId() == R.id.examPictureUpload) {
